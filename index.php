...
<div class="container">
    <div class="row">
        ...
        ?>  
        <div class="col-md-3">
            <div class="card mb-4 box-shadow" style="border: 1px solid blue">
            <a href="lapak.php?id=<?php echo $p['product_id'] ?>" >
                <img class="card-img-top" style="border: 1px solid blue" src="produk/<?php echo $p['product_image'] ?>" alt="<?php echo $p['product_name'] ?>">
                <div class="card-body">
